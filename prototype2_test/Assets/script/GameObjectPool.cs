...
public class GameObjectPool : MonoBehaviour
{
    ...
    public GameObject Object_Instantiate(GameObject newObject, float x, float y, float z,Quaternion q)
    {
        food_parent = GameObject.FindWithTag("FoodParent");
        ...
        if (poolDic[dic_str].Count == 0)
        {
            ...
            newObj.transform.parent = food_parent.transform;      //set parent
            return newObj ;
        }
        else
        {
